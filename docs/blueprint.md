...
**Publication potential:** realistic primary target EMNLP Findings / TMLR; ACL/EMNLP Main as a stretch conditional on clear, statistically significant gains over the published competitors (MoA — ICLR 2025 Spotlight; iMAD — AAAI 2026 Oral; ConsensAgent — Findings of ACL 2025); ACL/NeurIPS workshop as the safe floor.
